...
public class PopularFilmsAdapterPresenter extends ContinuousFilmAdapterPresenter {

    public PopularFilmsAdapterPresenter(DownloadNextPageIntent downloadNextPageIntent) {
