...
public class ScifiFilmsAdapterPresenter extends ContinuousFilmAdapterPresenter {

    public ScifiFilmsAdapterPresenter(DownloadNextPageIntent downloadNextPageIntent) {
